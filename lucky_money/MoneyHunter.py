...
class MoneyHunter:
    ...
    def login(self):
        ...
        driver_utils.waiting_element(self.driver, 'com.netease.play:id/youthModeBtn') \
            .click()

        # when update version notice appear, simulate pressing the back key
        driver_utils.waiting_element(self.driver, 'com.netease.play:id/updateVersionContent')
