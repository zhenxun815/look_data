            ...
            while True:
                ...
                if '抢' == btn_text:
                    ...
                    try:
                        ...
                        # if result_text.find('点击') > -1:
                        #     poco(name='com.netease.play:id/openButton').click()
                        #     print(f'grab again...')
...
def check_in():
    print(f'check in...')
    try:
        close_btn = poco(name='com.netease.play:id/closeBtn', type='android.widget.ImageView')
        if close_btn.exists():
            close_btn.click()
    except PocoNoSuchNodeException:
        print('check in not exist')
